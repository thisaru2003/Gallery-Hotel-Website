...
<head>
    ...
    <title>The Gallery Hotel - Parking</title>
...
<div class="container">
    <div class="gallery">
        ...
        <div class="grid-item" onclick="showDetails('Images/parking2.jpg')">
            <a>
        ...
        <div class="grid-item" onclick="showDetails('Images/parking12.jpg')">
            <a>
